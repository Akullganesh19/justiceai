...
// Self-healing: Auto-retry with exponential backoff for transient network errors and rate limits.
async function fetchWithRetry(url, options = {}, maxAttempts = 3, baseBackoff = 100) {
  for (let attempt = 1; attempt <= maxAttempts; attempt++) {
    ...
    console.warn(`[Retry ${attempt}/${maxAttempts}] Request to ${safeUrl} failed. Retrying in ${delay}ms...`);
