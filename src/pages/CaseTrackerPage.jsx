...
export default function CaseTrackerPage() {
  ...
  // Listen for global storage refreshes (e.g. from the Event Bridge)
  useEffect(() => {
    const handleRefresh = () => {
      try {
        const saved = localStorage.getItem(STORAGE_KEY);
    ...
    window.addEventListener('justice-ai-case-tracker-refreshed', handleRefresh);
    return () => window.removeEventListener('justice-ai-case-tracker-refreshed', handleRefresh);
  }, []);
