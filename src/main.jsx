...
// Dynamic imports mapping for predictive route prefetching
const routeChunks = {
...
// Global event listener to prefetch chunks on hover intent
  ...
  window.addEventListener('mouseover', (e) => {
    ...
    if (link && link.origin === window.location.origin) {
      try {
        ...
        const keys = Object.keys(routeChunks);
        for (const key of keys) {
          if (pathname === key || (key !== '/' && key !== '*' && pathname.startsWith(key + '/'))) {
