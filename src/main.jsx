...
// Oracle Predictive Routing Engine
// Maps routes directly to their lazy-loading functions so we can invoke them
// *before* the user clicks, when they simply move their mouse towards a link.
const routeChunks = {
...
// Start prefetching if user hovers or touches a link
  ...
  const prefetchRoute = (e) => {
    ...
    try {
      ...
      if (url.origin === window.location.origin) {
        // use URL pathname to ignore query params and hash
