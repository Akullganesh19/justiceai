...
// Route chunk mappings for predictive prefetching
const routeChunks = {
...
// 🛸 Oracle: Predictive Intent-based Prefetching
// Anticipate navigation based on cursor movement towards links.
  ...
  window.addEventListener('mouseover', (e) => {
    ...
    if (target && target.href) {
      try {
        ...
        // Only predictively fetch for internal routes
        if (url.origin === window.location.origin) {
          ...
          if (chunkLoader) {
            ...
            // .catch() to silently swallow chunk loading errors without disrupting UI.
            chunkLoader().catch((_err) => {});
          }
        }
      } catch (_err) {
