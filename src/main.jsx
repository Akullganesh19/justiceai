...
// 🛸 Predictive Route Prefetching (Oracle)
if (typeof window !== 'undefined') {
  ...
  // Attach with passive true so it doesn't block main thread
  document.addEventListener('mouseover', prefetchRoute, { passive: true });
  document.addEventListener('touchstart', prefetchRoute, { passive: true });
}
