...
// Intelligent Route Prefetching Map
const routeChunks = {
...
// Global prefetch listener for predictive intelligence
  ...
  if (link && link.href) {
    try {
      ...
      if (url.origin === window.location.origin) {
        ...
        // Handle nested routes or fallback by prefix
        if (!match) {
        ...
        if (match) {
          match().catch(() => {}); // prefetch and swallow errors
        }
      }
    } catch (_err) {
      // ignore invalid urls
