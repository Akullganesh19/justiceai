...
// Oracle: Hover-based Route Chunk Prefetching
// Store mapping of paths to dynamic imports
const routeChunks = {
...
// Global mouseover listener to trigger prefetch
if (typeof window !== 'undefined') {
  document.addEventListener('mouseover', (e) => {
    ...
    if (importFn) {
      importFn().catch(() => {}); // Swallow chunk loading errors quietly
    }
  });
}
