...
// Root Layout wraps the entire app, providing context and overlays
function RootLayout({ onTranscription }) {
  return (
    <>
      <div className="grain-overlay" aria-hidden="true" />
      <ScrollToTop />
      <CommandPalette />
      <FloatingVoiceButton onTranscription={onTranscription} />
...
const router = createBrowserRouter([
  {
    path: "/",
    element: <RootLayout onTranscription={handleGlobalTranscription} />,
    children: [
